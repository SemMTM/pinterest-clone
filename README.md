...
| A user can upload the same image multiple times by fast pressing the submit button before the POST request is complete | Disable the buttons functionality until the POST request is complete |
